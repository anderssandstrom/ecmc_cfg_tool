...
and status information, and can open `ecmcMain.ui` or the command parser from
...
last used value. The default hostname PV suffix is `MCU-Cfg-Hostname`; change it in
